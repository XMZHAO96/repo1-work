...
//D3D12_CPU_DESCRIPTOR_HANDLE feedimg(int count)
//{

   // int descriptor_index = count;
   ...
   // return  my_texture_srv_cpu_handle;

//}

 void testD3D(ImVec4 clear_color)
{
...
bool CreateDeviceD3D(HWND hWnd)
{
...

    {
        ...
        desc.NumDescriptors = 50;//set to 2
